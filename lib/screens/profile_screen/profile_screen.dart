              ...
              children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: OutlinedButton(
                            onPressed: ()async{
                              await launchUrl(Uri.parse("tel:+201284464432"));
                            },
                            child:Row(
                              children: [
                                const Icon(Icons.phone_callback_outlined,color: Colors.brown,),
                                const SizedBox(width: 7,),
                                Text("27".tr,style: const TextStyle(
                                  color: Colors.brown,
                ...
                listtile(
                    ...
                    onpressed: (){
                      ...
                      warningDialog(title: '33'.tr, subtitle: '34'.tr, fct:()async{
